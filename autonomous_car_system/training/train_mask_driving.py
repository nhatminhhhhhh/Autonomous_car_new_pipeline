...
Pipeline:
  1. Load dữ liệu (mask.png, steering) đã thu thập từ TeleoperationCollector
  2. Train MaskDrivingNet với HuberLoss
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help='Thư mục collected_driving (chứa mask_*.png + frame_*.json)',
    )
    parser.add_argument(
        '--epochs', type=int,
...
def train():
    ...
    if len(full_dataset) == 0:
        print("[ERROR] Dataset rỗng! (không tìm thấy mask_*.png nào)")
        return
